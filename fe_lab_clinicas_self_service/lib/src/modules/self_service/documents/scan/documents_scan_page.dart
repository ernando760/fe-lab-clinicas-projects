          ...
          child: Container(
            ...
            child: Column(
              children: [
                ...
                const Text("TIRAR A FOTO AGORA",
                    style: LabClinicasTheme.titleSmallStyle),
                const SizedBox(height: 25),
                const Text(
                    "Posicione o documento do quadrado abiaxo e aperte o botão para tirar a foto",
                ...
                FutureBuilder(
                  ...
                  builder: (context, snapshot) {
                    ...
                    return const Center(child: Text("Erro ao carregar camera"));
                  },
                ),
                const SizedBox(height: 20),
                SizedBox(
