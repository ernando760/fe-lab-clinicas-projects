...
class LabClinicasApplicationBindings extends ApplicationBindings {
  ...
  List<Bind<Object>> bindings() => [
        ...
        Bind.lazySingleton<PatientInformationFormRepository>((i) =>
            PatientInformationFormRepositoryImpl(restClient: i<RestClient>())),
        Bind.lazySingleton<AttendantDeskAssignmentRepository>((i) =>
            AttendantDeskAssignmentRepositoryImpl(restClient: i<RestClient>())),
        Bind.lazySingleton<PainelRepository>(
            (i) => PainelRepositoryImpl(restClient: i<RestClient>())),
        Bind.lazySingleton<CallNextPatientService>((i) =>
            CallNextPatientService(
                patientInformationFormRepository:
                    i<PatientInformationFormRepository>(),
                attendantDeskAssignmentRepository:
                    i<AttendantDeskAssignmentRepository>(),
                painelRepository: i<PainelRepository>())),
      ];
}
